...
class TopDrawerTabs extends LitElement {
  ...
  get #tabs() {
    return this.dashboard.getComponentIdsOfType('topDrawerTab');
  }
  ...
  #updateCurrentEditor() {
    ...
    this.currentTab = this.dashboard.create('topDrawerTab', this.selectedTab);
...
customElements.define('dashboard-top-drawer-tabs', TopDrawerTabs);