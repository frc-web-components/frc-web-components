...
import styles from './StringArrayEditor.module.scss';
import { ColDef } from 'ag-grid-community';
import { useEffect, useMemo, useState } from 'react';
import SimpleDialog from './SimpleDialog';

interface StringArrayContext {
...
export const StringRenderer = (
  props: CustomCellRendererProps<StringValue, string, StringArrayContext>,
) => {
...
export const StringArrayEditor = (
  ...
  const [value, setValue] = useState(props.value ?? []);
  const stringArray: StringValue[] = useMemo(() => {
  ...
  return (
    ...
    >
      <div
        ...
        className={styles['string-array-editor']}
      >
        <div
          style={{ flex: '1', width: '100%' }}
          className={'ag-theme-balham-dark'}
        >
          <AgGridReact<StringValue>
