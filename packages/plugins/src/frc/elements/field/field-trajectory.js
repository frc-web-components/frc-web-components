...
export const elementConfig = {
  ...
  properties: {
    ...
    color: { type: String, input: { type: 'ColorPicker' }, defaultValue: '#FFA500' }
  },
};
...
class FieldTrajectory extends FieldObject {
  ...
  renderDrawing({ bottomCtx, scalingFactor }) {
    ...
    this.drawArrow(bottomCtx, startingPose[0], -startingPose[1], startingPose[2], scalingFactor);
    this.drawArrow(bottomCtx, endingPose[0], -endingPose[1], endingPose[2], scalingFactor);
  }
