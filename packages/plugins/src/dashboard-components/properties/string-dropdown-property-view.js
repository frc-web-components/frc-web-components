...
class StringDropdownPropertyView extends PropertyView {
  ...
  allowCustomValues() { 
    ...
    return 'allowCustomValues' in input
  ...
  getOptions() {
    ...
    return typeof getOptions === 'function' ? getOptions.bind(this.element)() : [];
  }
  ...
  renderInputField() {
    ...
    return html`
      <div class="input-container">
        ...
        ${this.allowCustomValues() && this.property?.input?.enableUpload ? html`
          <vaadin-button 
