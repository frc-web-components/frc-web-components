...
htmlhelp_basename = 'frc-web-componentsdoc'
...
latex_documents = [
    (master_doc, 'frc-web-components.tex', 'frc-web-components Documentation',
     'Amory Galili', 'manual'),
]
...
man_pages = [
    (master_doc, 'frc-web-components', 'frc-web-components Documentation',
     [author], 1)
]
