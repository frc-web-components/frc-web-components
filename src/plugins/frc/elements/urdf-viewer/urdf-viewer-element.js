...
export default class URDFViewer extends HTMLElement {
  ...
  get urdfContent() {
    return this.getAttribute('urdf-content') || '';
  }
  ...
  get maxDistance() {
    return this.getAttribute('max-distance') || 10;
  }
  get minDistance() {
    return this.getAttribute('min-distance') || 0.25;
  }

  get cameraX() {
    return this.getAttribute('camera-x') || 0;
  }
  set cameraX(val) {
    this.setAttribute('camera-x', val);
  }

  get cameraY() {
    return this.getAttribute('camera-y') || 0;
  }
  set cameraY(val) {
    this.setAttribute('camera-y', val);
  }

  get cameraZ() {
    return this.getAttribute('camera-z') || -10;
  }
  set cameraZ(val) {
    this.setAttribute('camera-z', val);
  }

  get robotX() {
    return this.getAttribute('robot-x') || 0;
  }
  get robotY() {
    return this.getAttribute('robot-y') || 0;
  }
  get robotZ() {
    return this.getAttribute('robot-z') || 0;
  }

  get autoRotate() {
    return this.hasAttribute('auto-rotate') || false;
  }
  get autoRotateSpeed() {
    return this.getAttribute('auto-rotate-speed') || 2;
  }
